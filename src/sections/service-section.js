  ...
  features: [
    {
      ...
      text:
        'Mantenga su local en condiciones de higiene y seguridad para su desarrollo comerical con nuestros productos aprobados por la ANMAT.',
    },
    {
      id: 2,
      ...
      text:
        'Simplifique las complejas tareas de limpieza y mantenimiento en nuestras manos. Contamos con equipo altamente profesionalizado.',
    },
  ],
};
...
export default function ServiceSection() {
  ...
  return (
    <section id="covid" sx={{ variant: 'section.services' }}>
      <Container sx={styles.containerBox}>
        <Box sx={styles.thumbnail}>
          <Image src={BannerImg} alt="Thumbnail" style={{borderRadius:"15px"}} />
          <Button
            sx={styles.videoBtn}
            onClick={handleClick}
