        ...
        <Box sx={styles.contentBox}>
          <Box sx={styles.contentBoxInner}>
            ...
            <Text as="p" sx={styles.description}>
              La limpieza e higiene requiere de una práctica minuciosa, una atención personalizada y una solución que se adapte a sus necesidades. Contactenos para saber más.
            </Text>
            <form onSubmit={subscribe}>
              <Flex sx={styles.subscribeForm}>
                ...
                <Input
                  ...
                  name="email"
                  type="email"
                  placeholder="Ingrese tu email, nos contactaremos a la brevedad"
                />
